navigator = {
    ...
    appMinorVersion: "0",
    appName: "Netscape",
    appVersion: "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.109 Safari/537.36",
    cookieEnabled: true,
    deviceMemory: 8,
    doNotTrack: null,
...
function get_as_cp_signature(uid, max_behot_time) {
    ...
    var params = getHoney();
    params._signature = TAC.sign(uid+""+max_behot_time);
